...
# Generating
echo '#Iters Seconds TestAccuracy TestLoss Top5Acc'> $LOG.test.txt
paste aux0.txt aux4.txt aux1.txt aux5.txt aux2.txt | column -t >> $LOG.test.txt
...
# Generating
echo '#Iters Seconds TrainingLoss LearningRate softmax_loss'> $LOG.train.txt
paste aux0.txt aux3.txt aux1.txt aux2.txt aux5.txt | column -t >> $LOG.train.txt
rm aux.txt aux0.txt aux1.txt aux2.txt  aux3.txt aux5.txt 
