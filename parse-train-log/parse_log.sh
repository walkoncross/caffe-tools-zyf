...
# Generating
echo '#Iters Seconds TestAccuracy TestLoss'> $LOG.test.txt
paste aux0.txt aux4.txt aux1.txt aux2.txt | column -t >> $LOG.test.txt
...
# Generating
echo '#Iters Seconds TrainingLoss LearningRate'> $LOG.train.txt
paste aux0.txt aux3.txt aux1.txt aux2.txt | column -t >> $LOG.train.txt
